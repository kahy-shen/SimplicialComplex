...
class simplices:
    ...
    def special_simplices_S(self, id2user):
        ...
        # print(topL2T)
        with open('data/enron/simplices_S_name.json', 'w') as outfile:
            l2t = json.dumps(l2t, indent=4)
            outfile.write(l2t)
            outfile.close()
        with open('data/enron/top_20_simplices_S_name.json', 'w') as outfile:
    ...
    def special_simplices_T(self, id2user):
        ...
        with open('data/enron/simplices_T_name.json', 'w') as outfile:
           s2s = json.dumps(simplices2simplices, indent=4)
           outfile.write(s2s)
           outfile.close()
        with open('data/enron/strong_simplices_T_name.json', 'w') as outfile:
           s2s = json.dumps(strong_simplices, indent=4)
           outfile.write(s2s)
           outfile.close()
        with open('data/enron/top_20_simplices_T_name.json', 'w') as outfile:
...
if __name__ == '__main__':
    ...
    simplex = simplices(3, "data/enron/enron_edges.txt", id2user)
